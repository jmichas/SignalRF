...
package com.worlize.websocket
{
	...
	public class WebSocket extends EventDispatcher
	{
		...
		private var _authorizationHeader:String = null;
		public function setAuthorizationHeader(username:String, password:String):void{
			var encoder:Base64Encoder = new Base64Encoder();
			encoder.insertNewLines = false;
			encoder.encode(username + ":" + password);
			_authorizationHeader = "Authorization: Basic " + encoder.toString();
			trace(_authorizationHeader);
		}
		...
		private var _headers:Dictionary = new Dictionary();
		...
		private function sendHandshake():void {
			...
			var headerKeys:Array = DictionaryUtil.getKeys(_headers);
			for(var x:int = 0; x < headerKeys.length; x++){
				text += headerKeys[x] + ": " + _headers[headerKeys[x]] + "\r\n";
			}
			if(_authorizationHeader!=null){ //Added JJM 12/7/2013
				text += _authorizationHeader + "\r\n";
			}
